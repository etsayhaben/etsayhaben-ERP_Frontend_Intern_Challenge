...
// ── GLOBAL STATE ─────────────────────────────────────────────────
// Reads values WRITTEN by the feature modules' hooks (useInventory,
// useEmployees). The Navbar has no idea HOW these counts were
// calculated — it just displays whatever is currently in the store.
